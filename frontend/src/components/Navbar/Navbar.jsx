                ...
                <div className="container flex justify-between">
                                    ...
                                    <ul className='space-y-2'> 
                                        {
                                            ...
                                            <li>
                                                <a className=' text-gray-500 hover:text-black dark:hover:text-white duration-200 inline-block w-full py-2 hover:bg-primary rounded-md font-semibold' href={data.link}>{data.name}</a>
                                            </li>
                                            ))
                                        }
                                    </ul>
                    ...
                    <div className='flex justify-between items-center gap-4'>
                        <div className='relative group hidden sm:block'>
                            ...
                            <IoMdSearch className='text-xl text-gray-600 group-hover:text-primary dark:text-gray-400 absolute top-3 -translate-y-1 right-3 duration-200' />
                        </div>
                        <button className='relative p-3'>
                            <FaCartShopping className='text-xl text-gray-400 dark:text-gray-400' />
